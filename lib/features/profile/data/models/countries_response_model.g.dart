...
class CountriesResponseModelAdapter
    extends TypeAdapter<CountriesResponseModel> {
  @override
  final int typeId = 0;

  @override
  CountriesResponseModel read(BinaryReader reader) {
    ...
    return CountriesResponseModel(
      ...
      livePrices: (fields[12] as List?)?.cast<Price>(),
      blackMarketPrices: (fields[13] as List?)?.cast<Price>(),
      bankPrices: (fields[14] as List?)?.cast<Price>(),
    );
  }

  @override
  void write(BinaryWriter writer, CountriesResponseModel obj) {
    writer
      ..writeByte(15)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is CountriesResponseModelAdapter &&
