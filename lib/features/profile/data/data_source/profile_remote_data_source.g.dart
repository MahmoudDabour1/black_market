...
class _ProfileRemoteDataSource implements ProfileRemoteDataSource {
  ...
  @override
  Future<List<CountriesResponseModel>> getCountries() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<CountriesResponseModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<CountriesResponseModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              CountriesResponseModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
